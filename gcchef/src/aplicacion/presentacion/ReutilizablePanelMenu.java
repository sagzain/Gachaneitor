...
public class ReutilizablePanelMenu extends JPanel {
     ...
     * Create the panel.
     */
    public ReutilizablePanelMenu(String texto) {
        setBackground(Color.WHITE);
        if(texto == "")setBackground(Color.WHITE);
        if(texto != "")setBorder(new SoftBevelBorder(BevelBorder.RAISED, null, null, null, null));
        ...
        if(texto != "") lblNewLabel_1.setIcon(new ImageIcon(ReutilizablePanelMenu.class.getResource("/aplicacion/presentacion/resources/menu_peque.png")));
        ...
        label_nombre_menu = new JLabel(texto);
        ...
        if(texto != "")addMouseListener(new MouseAdapter() {
            @Override
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                selected = true;
                ((PanelSeleccionMenu) getParent().getParent().getParent().getParent()).setSelected(label_nombre_menu.getText());;
            }   
        });
    }
