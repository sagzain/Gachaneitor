...
public class PanelPasoSacar extends JPanel {

    private  JTextPane txtpnIntroducirElIngrediente;
    /**
     * Create the panel.
     */
    public PanelPasoSacar(String texto) {
        setBackground(new Color(102, 204, 255));
        GridBagLayout gridBagLayout = new GridBagLayout();
        gridBagLayout.columnWidths = new int[]{80, 0, 80, 300, 50, 0};
        ...
        lblNewLabel_1.setIcon(new ImageIcon(PanelPasoSacar.class.getResource("/aplicacion/presentacion/resources/comida-y-restaurante.png")));
        ...
        txtpnIntroducirElIngrediente.setText("Sacar "+texto+" del recipiente de la maquina.");
